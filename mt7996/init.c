...
static const u8 if_types_ext_capa[] = {
...
static const struct wiphy_iftype_ext_capab iftypes_ext_capa[] = {
	{
		...
		.extended_capabilities = if_types_ext_capa,
		.extended_capabilities_mask = if_types_ext_capa,
		.extended_capabilities_len = sizeof(if_types_ext_capa),
		.mld_capa_and_ops =
...
mt7996_init_wiphy(struct ieee80211_hw *hw, struct mtk_wed_device *wed)
{
	...
	ieee80211_hw_set(hw, CONNECTION_MONITOR); /* FIXME */
